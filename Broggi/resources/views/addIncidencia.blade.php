...
@section('content')
    ...
    <div class="container border col-sm-9 mt-5 border rounded shadow-lg" style="padding: 40px;">
        ...
        <div class="desplegable">
            ...
            <div class="content">
                <select class="custom-select mt-4 mb-4">
                    <option selected>- Slecciona un tipus d'Alertant-</option>
                    <option value="1">Centre Sanitari</option>
                    <option value="2">Persona Afectada</option>
                    <option value="3">Entorn de l'Afectat</option>
                    <option value="4">Alertant VIP</option>
                  </select>
            </div>
        </div>        
        <!-- ********** Fin Desplegable 2 ********** -->
