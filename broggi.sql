...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-04-2020 a las 17:57:41
...
--
-- Estructura de tabla para la tabla `alertants`
--
...
--
-- Volcado de datos para la tabla `alertants`
--

INSERT INTO `alertants` (`id`, `nom`, `cognoms`, `adreca`, `municipis_id`, `telefon`, `tipus_alertant_id`) VALUES
(1, 'Fundació Sant Hospital', '', 'Pg. de Joan Brudieu, 8', 782, '973350050', 1),
(2, 'Hospital de Puigcerdà', '', 'Pl. de Santa Maria, 1', 592, '972880150', 1),
(3, 'Hospital Comarcal del Pallars', '', 'Pau Casals, 5', 851, '973652255', 1),
(4, 'Espitau Val d\'Aran', '', 'Espitau, 8', 891, '973640004', 1),
(5, 'Clínica de Ponent', '', 'Prat de la Riba, 79', 386, '973232943', 1),
(6, 'Hospital Santa Maria', '', 'Av. Alcalde Rovira Roure, 44', 386, '973727222', 1),
(7, 'Hospital Universitari Arnau de Vilanova de Lleida', '', 'Av. Alcalde Rovira Roure, 80', 386, '973248100', 1),
(8, 'Pius Hospital de Valls', '', 'Pl. Sant Francesc, s/n', 877, '977613000', 1),
(9, 'Centre Mèdic Quirúrgic Reus', '', 'Antoni Gaudí, 26', 610, '977010800', 1),
(10, 'Hospital Sant Joan de Reus', '', 'Josep Laporte, s/n', 610, '977337303', 1),
(11, 'Hospital del Vendrell', '', 'Carretera de Barcelona, s/n', 883, '977257900', 1),
(12, 'Hospital Sant Pau i Santa Tecla', '', 'Rambla Vella, 14', 807, '977259900', 1),
(13, 'Hospital Universitari Joan XXIII de Tarragona', '', 'Dr. Mallafré i Guasch, 4', 807, '977295800', 1),
(14, 'Hospital Verge de la Cinta de Tortosa', '', 'Esplanetes, 44-58', 848, '977519100', 1),
(15, 'Clínica Terres de l\'Ebre', '', 'Pl. Joaquim Bau, 6-8', 848, '977588200', 1),
(16, 'Hospital Comarcal d\'Amposta', '', 'Jacint Verdaguer, 11', 52, '977700050', 1),
(17, 'Hospital Comarcal Móra d\'Ebre', '', 'Benet i Messeguer, s/n', 472, '977401674', 1),
(18, 'Hospital de Figueres', '', 'Ronda del Rector Arolas, s/n', 290, '972501400', 1),
(19, 'Hospital de Palamós', '', 'Hospital, 36', 515, '972600160', 1),
(20, 'Hospital Sant Jaume d\'Olot', '', 'Mulleras, 15', 498, '972261800', 1),
(21, 'Clínica Girona', '', 'Joan Maragall, 26', 330, '972204500', 1),
(22, 'ICO Girona', '', 'Av. de França, s/n', 330, '972225833', 1),
(23, 'Hospital Universitari Doctor Josep Trueta de Girona', '', 'Av. de França, s/n', 330, '972940200', 1),
(24, 'Hospital Santa Caterina', '', 'Dr. Castany, s/n (Parc Hospitalari Martí i Julià)', 651, '972182500', 1),
(25, 'Hospital Comarcal Sant Jaume de Calella', '', 'Sant Jaume, 209', 161, '937690201', 1),
(26, 'Clínica Salus Infirmorum', '', 'Av. Mossèn Lluís Constans, 130', 87, '972570208', 1),
(27, 'Hospital de Campdevànol', '', 'Ctra. de Gombrèn, 20', 170, '972730013', 1),
(28, 'Hospital Comarcal de Blanes', '', 'Accés cala Sant Francesc, 5', 125, '972353264', 1),
(29, 'Hospital d\'Igualada', '', 'Av. Catalunya, 11', 360, '938075500', 1),
(30, 'Centre Hospitalari', '', 'Av. de les Bases de Manresa, 6-8', 410, '938732550', 1),
(31, 'Hospital Sant Joan de Déu', '', 'Dr. Joan Soler, s/n', 410, '938742112', 1),
(32, 'Hospital Comarcal Sant Bernabé', '', 'Ctra. de Ribes, s/n', 114, '938243400', 1),
(33, 'Hospital General de Vic', '', 'Francesc Pla El Vigatà, 1', 888, '938891111', 1),
(34, 'Hospital Comarcal de l\'Alt Penedès', '', 'Espirall, s/n', 903, '938180440', 1),
(35, 'Hospital Sant Joan de Déu', '', 'Av. Mancomunitats Comarcals, 1', 414, '937742020', 1),
(36, 'Hospital General. Parc Sanitari Sant Joan de Déu', '', 'Camí Vell de la Colònia, 25', 661, '936615208', 1),
(37, 'Hospital de Viladecans', '', 'Av. de Gavà, 38', 898, '936590111', 1),
(38, 'Hospital Sant Joan de Déu', '', 'Pg. de Sant Joan de Déu, 2', 270, '932532100', 1),
(39, 'Hospital de Sant Joan Despí Moisès Broggi', '', 'Jacint Verdaguer, 90', 695, '935531200', 1),
(40, 'Hospital del Mar', '', 'Pg. Marítim, 25-29', 91, '932483000', 1),
(41, 'Hospital Plató', '', 'Plató, 21', 91, '933069900', 1),
(42, 'Hospital de l\'Esperança', '', 'Sant Josep de la Muntanya, 12', 91, '933674100', 1),
(43, 'Fundació Puigvert / Iuna', '', 'Cartagena, 340', 91, '934169700', 1),
(44, 'Hospital Dos de Maig', '', 'Dos de Maig, 301', 91, '935072700', 1),
(45, 'Hospital Casa Maternitat', '', 'Sabino de Arana, 1', 91, '932275600', 1),
(46, 'Hospital Universitari Sagrat Cor', '', 'Viladomat, 288', 91, '933221111', 1),
(47, 'Hospital Universitari General de la Vall d\'Hebron', '', 'Pg. de la Vall d\'Hebron, 119-129', 91, '934893000', 1),
(48, 'Hospital Sant Rafael', '', 'Pg. de la Vall d\'Hebron, 107', 91, '932112508', 1),
(49, 'Hospital Universitari Maternoinfantil de la Vall d\'Hebron', '', 'Pg. de la Vall d\'Hebron, 119-129', 91, '934893000', 1),
(50, 'Hospital Universitari de Traumatologia i Rehabilitació de la Vall d\'Hebron', '', 'Pg. de la Vall d\'Hebron, 119-129', 91, '934893000', 1),
(51, 'Hospital Clínic i Provincial de Barcelona', '', 'Villarroel, 170', 91, '932275400', 1),
(52, 'Hospital de la Santa Creu i Sant Pau', '', 'Sant Quintí, 89', 91, '935537160', 1),
(53, 'Hospital General de l\'Hospitalet', '', 'Josep Molins, 29', 357, '934407500', 1),
(54, 'ICO L\'Hospitalet', '', 'Av. de la Granvia, s/n km 2,7 (Hospital Duran i Reynals)', 357, '932607733', 1),
(55, 'Hospital Universitari de Bellvitge', '', 'Feixa Llarga, s/n', 357, '932607500', 1),
(56, 'Hospital Municipal Badalona', '', 'Via Augusta, 9-13', 79, '934648300', 1),
(57, 'Institut Guttmann', '', 'Camí de Can Ruti, s/n', 79, '934977700', 1),
(58, 'ICO Badalona', '', 'Ctra. de Canyet, s/n', 79, '934978710', 1),
(59, 'Hospital Universitari Germans Trias i Pujol de Badalona', '', 'Ctra. de Canyet, s/n', 79, '934651200', 1),
(60, 'Fundació Hospital de l\'Esperit Sant', '', 'Av. de Mossèn Josep Pons i Robadà, s/n', 743, '933860202', 1),
(61, 'Fundació Hospital Comarcal Sant Antoni Abat', '', 'Rambla de Sant Josep, 21', 926, '938931616', 1),
(62, 'Fundació Hospital Residència Sant Camil', '', 'Ctra. de Puigmoltó, km 0,8', 720, '938960025', 1),
(63, 'Hospital de Mataró', '', 'Ctra. de Cirera, s/n', 431, '937417700', 1),
(64, 'Hospital de Sabadell', '', 'Parc Taulí, s/n', 643, '937231010', 1),
(65, 'Hospital Mútua Terrassa', '', 'Pl. Dr. Robert, 5', 816, '937365050', 1),
(66, 'Hospital de Terrassa', '', 'Ctra. de Torrebonica, s/n', 816, '937310007', 1),
(67, 'Fundació Privada Hospital de Mollet', '', 'Sant Llorenç, 39', 444, '935760300', 1),
(68, 'Hospital General de Granollers', '', 'Av. de Francesc Ribas, s/n', 341, '938425000', 1),
(69, 'Hospital de Sant Celoni', '', 'Av. de l\'Hospital, 19', 665, '938670617', 1);
...
--
-- Estructura de tabla para la tabla `estats_incidencia`
--
...
--
-- Estructura de tabla para la tabla `incidencies_has_afectats`
--
...
--
-- Estructura de tabla para la tabla `incidencies_has_recursos`
--
...
--
-- Estructura de tabla para la tabla `incidencies_has_usuaris`
--
...
--
-- Estructura de tabla para la tabla `tipus_alertant`
--
...
--
-- Volcado de datos para la tabla `tipus_alertant`
--

INSERT INTO `tipus_alertant` (`id`, `tipus`) VALUES
(1, 'Centre sanitari'),
(2, 'El propi afectat'),
(3, 'Entorn de l\'afectat'),
(4, 'Alertant VIP'),
(5, 'Alertant accidental');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tipus_incident`
--
...
--
-- Volcado de datos para la tabla `tipus_incident`
--

INSERT INTO `tipus_incident` (`id`, `tipus`) VALUES
(1, 'Accidents i traumatismes'),
(4, 'Consulta mèdica'),
(3, 'Malaltia a domicili'),
(2, 'Malaltia a un lloc públic'),
(5, 'Transport sanitari');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tipus_recurs`
--
...
--
-- Volcado de datos para la tabla `tipus_recurs`
--

INSERT INTO `tipus_recurs` (`id`, `tipus`) VALUES
...
(1, '1', 'admin@admin.com', '123456', 1),
(2, 'jerat', 'gerard', '$2y$10$2XuvfK16R7ukvq5VJhqYp.J3wzvnxlgKzcB1Z74DT5Zo8cSqsFfxW', 2),
(3, 'qlq', 'Aleedio', '$2y$10$mwyo7vEM4NR4c2kjoxAcTORrAWeuN.Vkn.31F6ho19aD8pzqKYofO', 3),
(4, 'qlqrqwerqwe', 'rfew', '$2y$10$CEEeX7sfphyMSbLAyUoEAuNrQc8GcIjIDqAfNkbrA1eNgdUxGs7RK', 2),
(5, 'admin', 'admin', '$2y$10$TbGZo/O8kNX.u6d3BwgZyu3qzm4lW3ghGJCJ3aytdsj2YbOYMJZiq', 1);
...
--
-- Indices de la tabla `afectats`
--
ALTER TABLE `afectats`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_afectats_municipis1_idx` (`municipis_id`);

--
-- Indices de la tabla `alertants`
--
ALTER TABLE `alertants`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_alertants_tipus_alertant_idx` (`tipus_alertant_id`),
...
--
-- Indices de la tabla `estats_incidencia`
--
ALTER TABLE `estats_incidencia`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `estat_UNIQUE` (`estat`);
...
ALTER TABLE `incidencies`
  ...
  ADD KEY `fk_incidencies_tipus_incident1_idx` (`tipus_incident_id`),
  ADD KEY `fk_incidencies_estats_incidencia1_idx` (`estats_incidencia_id`),
  ADD KEY `fk_incidencies_tipus_alertant1_idx` (`tipus_alertant_id`),
  ADD KEY `fk_incidencies_alertants1_idx` (`alertants_id`);

--
-- Indices de la tabla `incidencies_has_afectats`
--
ALTER TABLE `incidencies_has_afectats`
  ...
  ADD KEY `fk_incidencies_has_afectats_incidencies1_idx` (`incidencies_id`);

--
-- Indices de la tabla `incidencies_has_recursos`
--
...
--
-- Indices de la tabla `incidencies_has_usuaris`
--
ALTER TABLE `incidencies_has_usuaris`
  ADD PRIMARY KEY (`incidencies_id`,`usuaris_id`),
  ADD KEY `fk_incidencies_has_usuaris_usuaris1_idx` (`usuaris_id`),
  ADD KEY `fk_incidencies_has_usuaris_incidencies1_idx` (`incidencies_id`);
...
ALTER TABLE `recursos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_recursos_tipus_recurs1_idx` (`tipus_recurs_id`),
  ADD KEY `fk_recursos_usuario` (`id_usuario`);
...
--
-- Indices de la tabla `tipus_alertant`
--
ALTER TABLE `tipus_alertant`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tipus_incident`
--
ALTER TABLE `tipus_incident`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `tipus_UNIQUE` (`tipus`);

--
-- Indices de la tabla `tipus_recurs`
--
ALTER TABLE `tipus_recurs`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `afectats`
--
ALTER TABLE `afectats`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `alertants`
--
ALTER TABLE `alertants`
...
--
-- AUTO_INCREMENT de la tabla `tipus_alertant`
--
ALTER TABLE `tipus_alertant`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `tipus_incident`
--
ALTER TABLE `tipus_incident`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `tipus_recurs`
--
ALTER TABLE `tipus_recurs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- Filtros para la tabla `afectats`
--
ALTER TABLE `afectats`
  ADD CONSTRAINT `fk_afectats_municipis1` FOREIGN KEY (`municipis_id`) REFERENCES `municipis` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `alertants`
--
ALTER TABLE `alertants`
  ...
  ADD CONSTRAINT `fk_alertants_tipus_alertant` FOREIGN KEY (`tipus_alertant_id`) REFERENCES `tipus_alertant` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `incidencies`
  ...
  ADD CONSTRAINT `fk_incidencies_estats_incidencia1` FOREIGN KEY (`estats_incidencia_id`) REFERENCES `estats_incidencia` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  ADD CONSTRAINT `fk_incidencies_tipus_alertant1` FOREIGN KEY (`tipus_alertant_id`) REFERENCES `tipus_alertant` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_incidencies_tipus_incident1` FOREIGN KEY (`tipus_incident_id`) REFERENCES `tipus_incident` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `incidencies_has_afectats`
--
ALTER TABLE `incidencies_has_afectats`
  ...
  ADD CONSTRAINT `fk_incidencies_has_afectats_incidencies1` FOREIGN KEY (`incidencies_id`) REFERENCES `incidencies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `incidencies_has_recursos`
--
ALTER TABLE `incidencies_has_recursos`
...
--
-- Filtros para la tabla `incidencies_has_usuaris`
--
ALTER TABLE `incidencies_has_usuaris`
  ADD CONSTRAINT `fk_incidencies_has_usuaris_incidencies1` FOREIGN KEY (`incidencies_id`) REFERENCES `incidencies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_incidencies_has_usuaris_usuaris1` FOREIGN KEY (`usuaris_id`) REFERENCES `usuaris` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `recursos`
  ADD CONSTRAINT `fk_recursos_tipus_recurs1` FOREIGN KEY (`tipus_recurs_id`) REFERENCES `tipus_recurs` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_recursos_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuaris` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
