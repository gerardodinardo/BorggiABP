...
@section('content')
    ...
    <div class="row">
      <div class="col-sm-5">
          ...
          @if (Auth::check())
              ...
              <div class="row col-sm-12 text-center mt-5 d-flex justify-content-md-around">
                <a href="{{ url('/principalIncidencies') }}" class="logged_button_redirect">
                  Navega a Tauler d'Incidencies
              ...
              <div class="row col-sm-12 text-center mt-5 d-flex justify-content-md-around">
                <a href="{{ route('logout') }}" class="logged_button">- Tancar Sessió -</a>
              </div>
          @else
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <a href="{{ asset('/formacio') }}" id="formacio">
      Formació
